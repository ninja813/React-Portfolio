                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex flex-shrink-0 items-center">
                            <h1 className="text-white text-2xl flex flex-row  "><span className="text-[#01d48c] text-3xl"></span>Latif<span className="text-[#01d48c] text-3xl ml-4"></span>Yan<GiWolfHowl className='text-4xl text-white mx-4 ' /></h1>
                        </div>
